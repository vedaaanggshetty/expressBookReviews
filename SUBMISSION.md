...
curl -s -X PUT "http://localhost:5000/review/1?review=This+is+an+excellent+book+highly+recommended" \
  -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJkYXRhIjoidGVzdHBhc3MxMjMiLCJpYXQiOjE3NzUwMzY2OTMsImV4cCI6MTc3NTA0MDI5M30.HSdDOxNIVxEedIuYmtl-tQOA0sJhdvCjF0yIx39puKQ"
```
**Output:**
```
